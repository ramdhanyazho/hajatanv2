        ...
        <div class="col-xl-6 col-lg-6 mb-4">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <label style="bottom: -12.3px;position: inherit;padding-left: 15px;color: #005CAA;font-weight: bold;display: table;margin-bottom: -2.1rem;">undangan.mywedding.com/</label>
                    <input id="domain" type="text" class="form-control" placeholder="akudandia" style="padding-left: 220px;" value="<?= $order[0]->domain ?>"  onkeyup="nospaces(this)" required>
                    </div>
