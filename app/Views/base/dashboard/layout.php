...
<head>
    ...
    <link href="<?= base_url('assets/base'); ?>/img/faviconmc.png" rel="icon">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user/dashboard'); ?>">
            <div class="sidebar-brand-icon">
                <img src="<?= base_url('assets/base'); ?>/img/faviconmc.png">
            </div>
        ...
        <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://api.whatsapp.com/send?phone=6285322912294">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <p class="text-footer">&#169;2021 <a href="<?php echo base_url() ?>" rel="dofollow" target="_blank"><?= SITE_NAME ?></a> - <a href="https://mihapecode.com" rel="dofollow" target="_blank">Mihape Code</a></p>
                </div>
            </div>
        </footer>
        <!-- Footer -->
