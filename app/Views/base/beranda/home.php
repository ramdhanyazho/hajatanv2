        ...
        <div class="container align-items-end justify-content-center d-flex">
          <div class="row align-items-top text-left">
            ...
            <div class="col-12 col-sm-4 col-md-6 col-lg-4 m-auto">
              <img alt="image" class="img-fluid rounded-0" src="<?php echo base_url() ?>/assets/base/img/wd.png?<?= date("Y-m-d"); ?>">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row mt-5 align-items-center">
            ...
            <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center pt-4 pt-lg-0">
              <div class="fdb-box px-4 pt-5">
                ...
                <?php //$data = $this->db->get('setting')->getResult(); ?>
                <p class="h1 mt-5 mb-5">Rp <?php echo number_format($harga['harga']) ?></p>
      ...
      <footer class="fdb-block footer-small footer">
        ...
        <div class="col-12 text-lg-left">
            <p class="lead footer-social">
              <a href="https://youtube.com/mihapecode" target="_blank" class="mx-2"><i class="lni-twitter-filled" aria-hidden="true"></i></a>
              <a href="https://facebook.com/mihapecode" target="_blank" class="mx-2"><i class="lni-facebook-filled" aria-hidden="true"></i></a>
              <a href="https://instagram.com/mihapecode" target="_blank" class="mx-2"><i class="lni-instagram-filled" aria-hidden="true"></i></a>
            </p>
          </div>
            <div class="row text-center">
            <div class="col">
