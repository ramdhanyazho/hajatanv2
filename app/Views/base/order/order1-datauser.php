          ...
          <div class="col-12 col-md-8 col-lg-8 col-xl-6">
            ...
            <div class="row align-items-center">
              <div class="col mt-4">
                ...
                <label style="bottom: -12.3px;position: inherit;padding-left: 20px;color: #005CAA;font-weight: bold;display: table;margin-bottom: -1.2rem;">undangan.mywedding.com/</label>
                <input name="domain" type="text" class="form-control" placeholder="akudandia" style="padding-left: 200px;" value="<?php echo $domain; ?>"  onkeyup="nospaces(this)" required>
              </div>
            </div>
