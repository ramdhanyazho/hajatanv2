...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        ...
        <!-- <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalSettingweb">Simpan</button>
                </div>
            </div>
        </div> -->
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Setting Payment</h6>
                </div>
                <div class="card-body">
...
<!-- Modal -->
<div class="modal fade" id="modalSettingweb" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-primary" id="simpanSettingweb">Ya</button>
